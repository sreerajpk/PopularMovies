...
import com.sreeraj.popularmovies.animation.CallbackAnimation;
import com.sreeraj.popularmovies.utils.SpinnerLoadingUtils;
...
public class SpinnerLoading extends View implements CallbackAnimation.TransformationListener {
    ...
    public static final int DEFAULT_CIRCLE_COLOR = 0xffc62828;
    public static final int DEFAULT_CIRCLE_COLOR_MOVE = 0xffc62828;
    ...
    private ArrayList<com.sreeraj.popularmovies.Circle> circlePaths = new ArrayList<>();
    ...
    private void drawSpinner(Canvas canvas, int j, int i, float v, float handle_len_rate, float maxDistance) {
        ...
        final com.sreeraj.popularmovies.Circle circle1 = circlePaths.get(i);
        final com.sreeraj.popularmovies.Circle circle2 = circlePaths.get(j);
    ...
    private void reMakeFactors() {
        ...
        com.sreeraj.popularmovies.Circle circlePath = new com.sreeraj.popularmovies.Circle();
        ...
        for (int i = 1; i <= itemCount; i++) {
            circlePath = new com.sreeraj.popularmovies.Circle();
